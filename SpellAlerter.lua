...
module.Init = function()
	...
	if SCDB[module.name]["PVP trinket"] == nil then SCDB[module.name]["PVP trinket"] = true end
	if SCDB[module.name]["WOTF using"] == nil then SCDB[module.name]["WOTF using"] = true end
	if SCDB[module.name]["Watch drinking"] == nil then SCDB[module.name]["Watch drinking"] = true end
	if SCDB[module.name]["Watch manaburn"] == nil then SCDB[module.name]["Watch manaburn"] = true end
	if SCDB[module.name]["Color"] == nil then SCDB[module.name]["Color"] = {1, .2, .2, 1} end
