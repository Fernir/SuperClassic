...
function Stuffing:Layout(lb)
     ...
     if lb then
          ...
          f.editbox:SetFontObject("SystemFont_Outline_Small")
          f.detail:SetFontObject("SystemFont_Outline_Small")
          f.gold:SetFontObject("SystemFont_Outline_Small")
     ...
     f:SetBackdrop({ bgFile = "Interface\\Tooltips\\UI-Tooltip-Background", edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border", tileSize = 16, edgeSize = 16, insets = {left=3, right=3, top=3, bottom=3}, })
     ...
     if settings[option].bag_bars then
          ...
          fb:SetBackdrop({ bgFile = "Interface\\Tooltips\\UI-Tooltip-Background", edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border", tileSize = 16, edgeSize = 16, insets = {left=3, right=3, top=3, bottom=3}, })
          fb:SetBackdropColor(.01, .01, .01, .85)
          fb:SetBackdropBorderColor(.4, .4, .4, 1)
          ...
          if bag_cnt > 0 then
               ...
               if not (settings[option].hide_soulbag and bagType == ST_SOULBAG) then
                    ...
                    for j = 1, bag_cnt do
                         ...
                         normalTex:SetHeight(settings[option].bsize / 37 * 64)
                         normalTex:SetWidth(settings[option].bsize / 37 * 64)
                         normalTex:Show()
                         ...
                         scount:SetFontObject("SystemFont_Outline_Small")
                         b.scount = scount
